namespace CompanyManagement.Database.Base
{
    public abstract class BaseDao
    {
        ...
        public const string PROJECT_START = "ProjectName";
        ...
        public const string CHECK_OUT_STATUS= "CheckOutStatus";
        public const string CHECK_IN_OUT_TASK_ID = "TaskID";

        protected const string COMPLETED_TASK_TABLE = "CompletedTask";
        public const string COMPLETED_TASK_ID = "ID";
        public const string COMPLETED_TASK_TASK_ID = "TaskID";
