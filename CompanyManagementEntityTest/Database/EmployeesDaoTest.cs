...
namespace CompanyManagementEntityTest.Database
{
    ...
    public class EmployeesDaoTest
    {
       ...
       // {
       //     var expected = new Employee { ID = "EM001", FullName = "Nguyễn Văn An", Gender = "Nam",
       //         Birthday = new DateTime(1990, 1, 1), IdentifyCard = "001234567890", 
       //         Email = "an.nguyen@it.company.com", PhoneNumber = "0123456789", 
       //         EmployeeAddress = "TP. Hồ Chí Minh", DepartmentID = "", RoleID = "ER01" };
       ...
       // {
       //     var empl = new Employee { ID = "EM12312", FullName = "Nguyễn Văn Anh Hoàng", Gender = "Nam",
       //         Birthday = new DateTime(2000, 1, 1), IdentifyCard = "075234567890", 
       //         Email = "an.nguyen12@gmail.com", PhoneNumber = "0123454357", EmployeeAddress = "Đồng Nai", 
       //         DepartmentID = "DMP124", RoleID = "ER04"};
       ...
       //     // update
       //     var updateObject = new Employee { ID = empl.ID, FullName = "Phạm Văn Hoàng", Gender = empl.Gender, 
       //         Birthday = empl.Birthday, IdentifyCard = empl.IdentifyCard, Email = "an.ng12@gmail.com", 
       //         PhoneNumber = "0123454456", EmployeeAddress = "Bạc Liêu", DepartmentID = "", RoleID = "ER01" };
