...
CREATE TABLE CompletedTask(
    FK_CheckInOutID varchar(20),
    TaskID varchar(20) PRIMARY KEY
)
GO
ALTER TABLE CompletedTask ADD CONSTRAINT FK_CompletedTask_CheckInOut
FOREIGN KEY(FK_CheckInOutID) REFERENCES CheckInOut(ID)
GO
...
GO
INSERT INTO CompletedTask(FK_CheckInOutID, TaskID)
VALUES
    ('CI00001', 'T000001'),
	('CI00001', 'T000002');
GO
